...
export default function TimePickerEnhancer() {
  ...
  return <style dangerouslySetInnerHTML={{ __html: `
    ...
    @media(max-width:860px){
      ...
      /* iOS Safari can paint the native date control a couple of pixels wider
         than its CSS width. Leave a 2px safety allowance so the right border
         stays fully visible inside the booking field without moving the input
         or affecting the native calendar interaction. */
      .booking-panel form .booking-birth-stacked>.field:has(#booking-birth-date)>#booking-birth-date{display:block!important;width:calc(100% - 2px)!important;inline-size:calc(100% - 2px)!important;min-width:0!important;min-inline-size:0!important;max-width:calc(100% - 2px)!important;max-inline-size:calc(100% - 2px)!important;box-sizing:border-box!important;padding:0!important;margin:0!important;}
      ...
      /* Keep the booking-specific 2px safety allowance after the shared date
         rule above, which otherwise restores 100% width. */
      .booking-panel form .booking-birth-stacked>.field:has(#booking-birth-date)>#booking-birth-date{width:calc(100% - 2px)!important;inline-size:calc(100% - 2px)!important;max-width:calc(100% - 2px)!important;max-inline-size:calc(100% - 2px)!important;}
